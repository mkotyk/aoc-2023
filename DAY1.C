...
int main() {
    ...
    result = 0;
    timer_start(&clock);
    read_input("day1.txt", handle_input_part1, handle_error, &result);
    ...
    timer_start(&clock);
	sample_input(sample_pt2, handle_input_part2, (void *) &result);
    ...
    result = 0;
    timer_start(&clock);
    read_input("day1.txt", handle_input_part2, handle_error, &result);
